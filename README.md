...
[![GoDoc](https://godoc.org/github.com/saurav-orca/gopy?status.svg)](https://godoc.org/github.com/saurav-orca/gopy)
[![CI](https://github.com/saurav-orca/gopy/workflows/CI/badge.svg)](https://github.com/saurav-orca/gopy/actions)
...
$ go install github.com/saurav-orca/gopy@latest
```
...
See the [CONTRIBUTING](https://github.com/saurav-orca/gopy/blob/master/CONTRIBUTE.md) guide for pointers on how to contribute to `gopy`.
...
https://godoc.org/github.com/saurav-orca/gopy
...
ex:
 ...
 $ gopy pkg github.com/saurav-orca/gopy/_examples/hi
...
Options:
  ...
  -url="https://github.com/saurav-orca/gopy": home page for project
...
ex:
 ...
 $ gopy exe github.com/saurav-orca/gopy/_examples/hi
...
ex:
 ...
 $ gopy gen github.com/saurav-orca/gopy/_examples/hi
...
ex:
 ...
 $ gopy build github.com/saurav-orca/gopy/_examples/hi
...
$ go get github.com/saurav-orca/gopy/_examples/hi
$ gopy build -output=out -vm=python3 github.com/saurav-orca/gopy/_examples/hi
$ ls out
...
```python
>>> import gopy
>>> hi = gopy.load("github.com/saurav-orca/gopy/_examples/hi")
gopy> inferring package name...
gopy> loading 'github.com/saurav-orca/gopy/_examples/hi'...
gopy> importing 'github.com/saurav-orca/gopy/_examples/hi'

>>> print hi
<module 'github.com/saurav-orca/gopy/_examples/hi' from '/some/path/.../hi.so'>
...
```
$ cd github.com/saurav-orca/gopy/_examples/hi
...
```
$ cd $GOPATH/src/github.com/saurav-orca/gopy
...
[Support matrix ](https://github.com/saurav-orca/gopy/blob/master/SUPPORT_MATRIX.md).
